...
class NetworkAwareness(app_manager.RyuApp):
	...
	def create_interior_links(self, link_list):
		...
		for link in link_list:
			src = link.src
			dst = link.dst
			self.link_swithes_port[(src.dpid,src.port_no)]=dst.dpid
			self.link_swithes_port[(dst.dpid, dst.port_no)] = src.dpid
	...
	def all_k_shortest_paths(self, graph, weight='weight', k=4):
		"""
