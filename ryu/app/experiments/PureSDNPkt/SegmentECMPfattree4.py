...
import argparse
from ryu.app.experiments import iperf_peers
import logging
import os
import sys
import signal
...
def createTopo(pod, density, ip="192.168.16.128", port=6653, bw_c2a=100, bw_a2e=100, bw_e2h=20):
	"""
	...
	k_paths = args.k ** 2 / 4
	fanout = args.k
	Controller_Ryu = Popen("ryu-manager --observe-links ./PureSDN/PureSDN.py --k_paths=%d --weight=hop --fanout=%d" % (k_paths, fanout), shell=True, preexec_fn=os.setsid)
