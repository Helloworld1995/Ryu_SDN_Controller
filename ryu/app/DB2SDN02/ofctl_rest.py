...
def stats_method(method):
    def wrapper(self, req, dpid, *args, **kwargs):
        ...
        try:
            ...
            return Response(content_type='application/json',headerlist=headlist,
                            body=json.dumps(ret))
        except ValueError:
...
def command_method(method):
    def wrapper(self, req, *args, **kwargs):
        ...
        # Invoke StatsController method
        try:
            ret=method(self, req, dp, ofctl, body, *args, **kwargs)
            return Response(status=200,headerlist=headlist,body=json.dumps("success"))
        except ValueError:
            LOG.exception('Invalid syntax: %s', req.body)
            return Response(status=400)
        except AttributeError:
...
class StatsController(ControllerBase):
    ...
    def get_dpids(self, req, **_kwargs):
        ...
        return Response(content_type='application/json',headerlist=headlist, body=body)
