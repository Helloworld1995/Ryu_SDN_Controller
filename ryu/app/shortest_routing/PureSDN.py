...
class ShortestForwarding(app_manager.RyuApp):
	...
	def install_flow(self, datapaths , dst_sw,link_to_port, path, flow_info, buffer_id,ip_src, ip_dst,data=None):
		'''
		...
		last_out_port = self.awareness.get_host_location(ip_dst)[1] #get last switch output
